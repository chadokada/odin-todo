...
class ProjectButton{
    constructor(name){
        this.name = name;
        this.projectBtn = new _pageelements_js__WEBPACK_IMPORTED_MODULE_3__.pageElement('div','user-project',
...
function loadPage(){
    ...
    if(!_storage_js__WEBPACK_IMPORTED_MODULE_4__.projectExists('inbox')){
