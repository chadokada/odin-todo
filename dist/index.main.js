...
function createAddTaskFormInputs(){
    ...
    const taskDescInput = new _pageelements_js__WEBPACK_IMPORTED_MODULE_2__.pageElement('textarea','task-desc-input','').get;
...
function createTask(task){
    ...
    const dueDate = new _pageelements_js__WEBPACK_IMPORTED_MODULE_2__.pageElement('div','due-date-collapsed',task.displayDueDate).get;
