...
function submitTask(){
    ...
    _storage_js__WEBPACK_IMPORTED_MODULE_4__.addTask(currentProjectName, taskName, taskDescription, 
        dueDate)
...
function createTask(task){
    ...
    const taskName = new _pageelements_js__WEBPACK_IMPORTED_MODULE_3__.pageElement('div','task-name-collapsed',task.name).get;
