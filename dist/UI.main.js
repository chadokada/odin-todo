...
class ProjectButton{
    constructor(name){
        ...
        this.projectName = new _pageelements_js__WEBPACK_IMPORTED_MODULE_0__.pageElement('div','', this.name).get;
    }
    #setIcon(){
        if (this.name == 'Inbox'){
