...
function showAddProjectForm(){ //addded to class
...
class addProjectForm {
    ...
    #submitForm(){
        ...
        if (projectName == ''){
            ...
            let projectSidebar = document.querySelector('.project-sidebar');
            let projectBtn = new _pageelements_js__WEBPACK_IMPORTED_MODULE_3__.pageElement('div','user-project',
