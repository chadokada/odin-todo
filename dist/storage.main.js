...
class Project{
    ...
    todayTasks(){
        ...
        for (let task of this.data.taskList){
            let dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(task.data.dueDate);
            let isTaskToday = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(dueDate);
            isTaskToday ? todayTaskList.push(task) : null;
        }
        return todayTaskList;
    }
    thisWeeksTasks(){
        let today = date_fns__WEBPACK_IMPORTED_MODULE_2__["default"]()
        let endOfWeek = date_fns__WEBPACK_IMPORTED_MODULE_3__["default"](date_fns__WEBPACK_IMPORTED_MODULE_4__["default"](today,{days: 7}))
        let thisWeek = {};
        for (let task of this.data.taskList){
            let dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(task.data.dueDate);
            if (date_fns__WEBPACK_IMPORTED_MODULE_5__["default"](dueDate, {start: today, end: endOfWeek})){
                if (thisWeek[dueDate]){
...
function getThisWeeksTasks(){
    ...
    let thisWeek = []
    let today = date_fns__WEBPACK_IMPORTED_MODULE_3__["default"]()

    for (let i = 0; i < 8; i++){
        let currentDay = date_fns__WEBPACK_IMPORTED_MODULE_4__["default"](today, {days: i});
